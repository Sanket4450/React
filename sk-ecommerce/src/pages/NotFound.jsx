...
export function NotFound() {
    return (
        <div className="flex flex-col text-center">
            ...
            <button className="mx-auto rounded-sm border-t-black border-s-black border-b-red-800 border-e-red-800 mt-14 border-t-2 border-s-2 border-b-8 border-e-8 w-52 text-sm font-bold py-4"><Link to="/">BACK TO HOME</Link></button>
        </div>
    )
}
