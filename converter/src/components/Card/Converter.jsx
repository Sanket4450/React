...
export function Converter({ options, fromOption, toOption, setFromOption, setToOption, switchOptions }) {
    return (
        <div className='flex justify-between items-center text-lg sm:text-xl lg:text-2xl'>
            ...
            <FontAwesomeIcon icon={faRightLeft} onClick={switchOptions} className='text-2xl sm:text-3xl hover:cursor-pointer' />
            <div>
